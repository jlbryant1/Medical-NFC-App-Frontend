...
data class PersonalProfileModel(
   ...
   */
  var txtVerify: String? = MyApp.getInstance().resources.getString(R.string.lbl_delete_account)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtVerifyOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_edit_details)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtVerifyTwo: String? = MyApp.getInstance().resources.getString(R.string.msg_add_emergency_c)
